...
void DemoBase::initParameters()
{
	...
	m_parameters.push_back(Parameter(ParameterIDs::SimMethod, "SimulationMethod", enumType, " label='Simulation method' enum='0 {WCSPH}, 1 {PCISPH}, 2 {PBF}, 3 {IISPH}, 4 {DFSPH}, 5 {Projective Fluids} , 6 {DFSPH c arrays}, 7 {DFSPH CUDA}' group=Simulation", this));
