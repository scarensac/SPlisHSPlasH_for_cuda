...
if("${show_ref_output}" MATCHES "refs/remotes/1d9cf800ab4cbb2af956577b99fdd355c16181ba")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "1d9cf800ab4cbb2af956577b99fdd355c16181ba")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "1d9cf800ab4cbb2af956577b99fdd355c16181ba")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Users/scarensac/Documents/GitHub/SPlisHSPlasH/extern/CompactNSearch/src/ExternalProject_CompactNSearch/'.\nYou will have to resolve the conflicts manually")
    endif()
