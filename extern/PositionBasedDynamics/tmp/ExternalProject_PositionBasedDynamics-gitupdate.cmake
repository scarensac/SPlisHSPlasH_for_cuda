...
execute_process(
  COMMAND "D:/Users/scarensac/AppData/Local/GitHubDesktop/app-1.0.6/resources/app/git/cmd/git.exe" show-ref 39a5099c39df84494df14aaad6fb9af845793ff7
  WORKING_DIRECTORY "D:/Users/scarensac/Documents/GitHub/SPlisHSPlasH/extern/PositionBasedDynamics/src/ExternalProject_PositionBasedDynamics"
...
if("${show_ref_output}" MATCHES "refs/remotes/39a5099c39df84494df14aaad6fb9af845793ff7")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "39a5099c39df84494df14aaad6fb9af845793ff7")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "39a5099c39df84494df14aaad6fb9af845793ff7")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "D:/Users/scarensac/AppData/Local/GitHubDesktop/app-1.0.6/resources/app/git/cmd/git.exe" rev-list --max-count=1 39a5099c39df84494df14aaad6fb9af845793ff7
  WORKING_DIRECTORY "D:/Users/scarensac/Documents/GitHub/SPlisHSPlasH/extern/PositionBasedDynamics/src/ExternalProject_PositionBasedDynamics"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/InteractiveComputerGraphics/PositionBasedDynamics.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Users/scarensac/Documents/GitHub/SPlisHSPlasH/extern/PositionBasedDynamics/src/ExternalProject_PositionBasedDynamics/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Users/scarensac/Documents/GitHub/SPlisHSPlasH/extern/PositionBasedDynamics/src/ExternalProject_PositionBasedDynamics/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "D:/Users/scarensac/AppData/Local/GitHubDesktop/app-1.0.6/resources/app/git/cmd/git.exe" checkout 39a5099c39df84494df14aaad6fb9af845793ff7
      WORKING_DIRECTORY "D:/Users/scarensac/Documents/GitHub/SPlisHSPlasH/extern/PositionBasedDynamics/src/ExternalProject_PositionBasedDynamics"
      RESULT_VARIABLE error_code
      )
    if(error_code)
